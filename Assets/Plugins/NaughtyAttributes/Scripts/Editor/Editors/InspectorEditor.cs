...
namespace NaughtyAttributes.Editor
{
    ...
    public class InspectorEditor : UnityEditor.Editor
    {
        ...
        private IEnumerable<FieldInfo> componentGetters;
        ...
        private void OnEnable()
        {
            ...
            // Cache component getters
            this.componentGetters = ReflectionUtility.GetAllFields(
                this.target, cg => cg.GetCustomAttributes(typeof(GetComponentAttribute), true).Length > 0);
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            else
            {
                ...
                foreach (var field in componentGetters)
                {
                    GetComponent(field);
                }
